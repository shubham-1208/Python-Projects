...
def CreateBoard(num_rows, num_cols, num_cells):
    ...
    for i in range(conf_puzzle.RAND_NUM):
        ...
        elif direction == 2: blank_cell_idx = moveUP(board, blank_cell_idx, num_rows, num_cols)
        elif direction == 1: blank_cell_idx = moveDOWN(board, blank_cell_idx, num_cols)
